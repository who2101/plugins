...
{
	RegConsoleCmd("sm_xmaslights", Cmd_Christmasification, "Creates Christmas Lights"); 
...
{
	if(!CheckCommandAccess(client, "sm_noclip", ADMFLAG_GENERIC, true)) return Plugin_Handled;
	MainMenu(client);
